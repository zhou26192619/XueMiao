...
import com.easemob.UserProfileManager;
import com.easemob.applib.controller.HXSDKHelper;
import com.easemob.applib.model.HMHXSDKModel;
...
import com.easemob.receiver.CallReceiver;
 ...
 *
 */
public class HMHXSDKHelper extends HXSDKHelper {
    ...
    protected HXNotificationInfoProvider getNotificationListener() {
        ...
        return new HXNotificationInfoProvider() {
            ...
            public String getDisplayedText(EMMessage message) {
                ...
                Map<String,RobotUser> robotMap=((HMHXSDKHelper)HXSDKHelper.getInstance()).getRobotList();
...
//        appContext.startActivity(intent);
    ...
    protected HXSDKModel createModel() {
        return new HMHXSDKModel(appContext);
    }
        ...
        return new HXNotifier(){
            public synchronized void onNewMsg(final EMMessage message) {
                ...
                if (message.getChatType() == ChatType.Chat) {
                    ...
                    notNotifyIds = ((HMHXSDKModel) hxModel).getDisabledGroups();
                } else {
                    chatUsename = message.getTo();
                    notNotifyIds = ((HMHXSDKModel) hxModel).getDisabledIds();
                }
     ...
     */
    public HMHXSDKModel getModel(){
        return (HMHXSDKModel) hxModel;
    }
    ...
    public Map<String, User> getContactList() {
        if (getHXId() != null && contactList == null) {
            contactList = ((HMHXSDKModel) getModel()).getContactList();
        }
	...
	public Map<String, RobotUser> getRobotList() {
		if (getHXId() != null && robotList == null) {
			robotList = ((HMHXSDKModel) getModel()).getRobotList();
		}
		return robotList;
	}
    ...
    public void saveContact(User user){
    	...
    	((HMHXSDKModel) getModel()).saveContact(user);
    }
    ...
    public void updateContactList(List<User> contactInfoList) {
        ...
        ((HMHXSDKModel)getModel()).saveContactList(mList);
    }
